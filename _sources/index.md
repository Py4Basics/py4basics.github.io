...
新たな内容を付け加えてつつ，私なりに分かりやすい説明に努めました。ただ，内容は全てが同じではありませんが，**2025年10月10日の刊行を機に，それらのページは削除することとなりました**（書籍に含まれていないトピックは，削除せずに残します）。何卒ご理解の程，宜しくお願いします。

次の二つの姉妹サイトは継続してご覧になれます。
* [Pythonで学ぶマクロ経済学（中級＋レベル）](https://py4macro.github.io)
* [Pythonで学ぶ入門計量経済学](https://py4etrics.github.io)

そちらでもPythonの基本的な使い方を説明しておりますので，Pythonを使ったマクロ経済学・計量経済学の学習に使って頂ければ幸いです。
